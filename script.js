...
// we are asking to get the element with the id of story then manipulate the document by changing the color red to the story content.
	document.getElementById("story").style.color = "#ff0000"
	
story.textContent = `It's the year 30${dataObject.number}.  You have been working  for ${dataobject.quantity} days on a top-secret program that will change the world. Three men in black suits walk in and tell you to come with them. Naturally, you get out of your seat and  start ${dataObject.verb} in the opposite direction through a futuristic city filled with flying cars, robot assistants, and glowing buildings...
...
Because you have one-of-a-kind skills, you respond, "Eh, im working on a app that will fix ${dataObject.sideProject} I don't need your money. But you want to move to San Fran so you call them back on their sidekick. ${dataObject.ohone}... "why not but only if you pay me ${dataObject.two}x the normal pay rate." They agree. You get into your flying car and drive yourself to your coworkers house and finnish your app that  ${dataObject.sideProject} this app is a game changer..Finally your home, you pat yourself on the back and think, "you wished you stopped by 711 for some of their chicken wings." the end!!!`
